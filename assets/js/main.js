            ...
            self.$wrapper.on('click', '.btn-cart', function (e) {
                ...
                if (
                    ...
                    Riode.Minipopup.open({
                        ...
                        actionTemplate: '<div class="action-group d-flex mt-3"><a href="cart.html" class="btn btn-sm btn-outline btn-primary btn-rounded mr-2">View Cart</a><a href="checkout.html" class="btn btn-sm btn-primary btn-rounded">بررسی کنید</a></div>'
                    });
                }
            });
        }
            ...
            self.$wrapper.on('click', '.btn-compare', function (e) {
                ...
                if (
                    ...
                    Riode.Minipopup.open({
                        ...
                        price: $product.find('.product-variation-price').length > 0 ? $product.find('.product-variation-price').children('span').html() : $product.find('.product-price .price').html(),
                        count: $product.find('.quantity').val(),
                        actionTemplate: '<div class="action-group d-flex mt-3"><a href="compare.html" class="btn btn-sm btn-outline btn-primary btn-rounded mr-2"> مقایسه ها</a><a href="checkout.html" class="btn btn-sm btn-primary btn-rounded">بررسی کنید</a></div>'
                    });
                }
            });
        }
        ...
        initProductsCartAction: function () {
            Riode.$body
                    ...
                    if ($compareCol.length > 0) {
                        ...
                        $product.hasClass('product-single') ||
                            Riode.Minipopup.open({
                                ...
                                actionTemplate: '<div class="action-group d-flex"><a href="cart.html" class="btn btn-sm btn-outline btn-primary btn-rounded">View Cart</a><a href="checkout.html" class="btn btn-sm btn-primary btn-rounded">بررسی کنید</a></div>'
                            });
                    } else {
                        // if not product single, then open minipopup
                        $product.hasClass('product-single') ||
                ...
                .on('click', '.hotspot .btn-cart', function (e) {
                    ...
                    Riode.Minipopup.open({
                        message: 'موفقیت اضافه شد به سبد خرید ',
                        productClass: 'product-cart',
        ...
        initProductsCompareAction: function () {
            Riode.$body
                ...
                .on('click', '.product .btn-product-icon.btn-compare', function (e) {
                    ...
                    $product.hasClass('product-single') ||
                        Riode.Minipopup.open({
                            message: "به لیست مقایسه اضافه شد",
                            productClass: ' product-compare',
                            name: $product.find('.product-name').text(),
                            nameLink: $product.find('.product-name > a').attr('href'),
                            imageSrc: $product.find('.product-media img').attr('src'),
                            ...
                            price: $product.find('.product-price .new-price, .product-price .price').html(),
                            count: $product.find('.quantity').length > 0 ? $product.find('.quantity').val() : 1,
                            actionTemplate: '<div class="action-group d-flex"><a href="compare.html" class="btn btn-sm btn-outline btn-primary btn-rounded"> مقایسه ها</a><a href="checkout.html" class="btn btn-sm btn-primary btn-rounded">بررسی کنید</a></div>'
                        });
                });
        },
